...
import { getDeskConfig, getGotwWeeks } from "@/lib/desk";
      ...
      <section className="px-4 py-8 border-b border-[#2a2834]">
        <div className="max-w-6xl mx-auto space-y-4">
          ...
          <p className="text-center">
            ...
            {/* Game of the week */}
      {(() => {
        const board = getGotwWeeks();
        const filled = board.weeks.filter((w) => w.a && w.b);
          ...
          <section className="px-4 py-8 border-b border-[#2a2834]">
            <div className="max-w-xl mx-auto text-center space-y-2">
              <p className="text-[0.65rem] font-bold uppercase tracking-[0.2em] text-[var(--gold)]">
                Week {current.week} Game of the Week
              </p>
              <p className="text-2xl sm:text-3xl font-black">
                {current.a} <span className="text-[var(--gold)]">vs</span> {current.b}
              </p>
            </div>
          </section>
        );
